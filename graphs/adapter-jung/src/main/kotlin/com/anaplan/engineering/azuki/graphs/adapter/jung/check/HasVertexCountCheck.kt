...
import com.anaplan.engineering.azuki.graphs.adapter.api.GetVertexCountBehavior
import com.anaplan.engineering.azuki.graphs.adapter.jung.execution.ExecutionEnvironment

class HasVertexCountCheck(private val graphName: String, private val count: Long) : JungCheck,
    GetVertexCountBehavior() {
