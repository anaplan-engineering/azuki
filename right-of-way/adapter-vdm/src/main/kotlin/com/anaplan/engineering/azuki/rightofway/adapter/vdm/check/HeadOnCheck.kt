...
class HeadOnCheck(private val airspaceName: String, private val aircraft0: String,
    ...
    override fun build(builder: RightOfWayModuleBuilder): RightOfWayModuleBuilder {
        ...
        return builder.extend(
            requiredImports = setOf(RightOfWayRulesModule.headon.import),
            ...
            (
                ...
                ${checkEquals(actual = "${RightOfWayRulesModule.headon}(a0, a1)(airspace.delta_c, airspace.Theta_h)")}
            );
            """
            )
        )
