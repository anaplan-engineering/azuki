...
class TimeClosestPointApproachCheck(private val airspaceName: String, private val aircraft0: String,
                                    private val aircraft1: String, private val tCPA: Double) :
    ...
    override fun build(builder: RightOfWayModuleBuilder): RightOfWayModuleBuilder {
        ...
        return builder.extend(
            requiredImports = setOf(RightOfWayRulesModule.tCPA.import),
