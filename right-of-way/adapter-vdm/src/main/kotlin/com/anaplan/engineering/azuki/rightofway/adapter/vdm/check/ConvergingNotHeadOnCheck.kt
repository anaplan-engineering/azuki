...
class ConvergingNotHeadOnCheck(private val airspaceName: String, private val aircraft0: String,
                                        private val aircraft1: String) :
    ReifiedBehavior, DefaultVdmCheck {

    override val behavior = RightOfWayBehaviours.ConvergeNotHeadon
    ...
    override fun build(builder: RightOfWayModuleBuilder): RightOfWayModuleBuilder {
        ...
        return builder.extend(
            requiredImports = setOf(RightOfWayRulesModule.conv_not_headon.import),
            ...
            (
                ...
                ${checkEquals(actual = "${RightOfWayRulesModule.conv_not_headon}(a0, a1)(airspace.delta_c, airspace.Theta_h)")}
            );
            """
            )
        )
