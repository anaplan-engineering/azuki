...
interface RightOfWayImplementation :
    Implementation<RightOfWayActionFactory, RightOfWayCheckFactory,
        RightOfWayQueryFactory, RightOfWayActionGeneratorFactory, NoSystemDefaults>
