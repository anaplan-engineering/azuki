...
interface RightOfWayQueryFactory : QueryFactory {
    ...
    /** Aircraft names in [airspaceName]; intended as a [Collection]-typed driver for `forAll`. */
    fun aircraftNamesIn(airspaceName: String): Query<Set<String>> = UnsupportedQuery()
