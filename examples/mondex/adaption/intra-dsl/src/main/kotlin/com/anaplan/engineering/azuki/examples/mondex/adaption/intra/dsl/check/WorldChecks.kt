...
interface WorldChecks {
    ...
    fun worldHasTotalLost(worldName: String, lost: Int)
    fun worldHasTotalValue(worldName: String, value: Int)
    ...
    infix fun String.hasTotalLost(lost: Int) = worldHasTotalLost(this, lost)
    infix fun String.hasTotalValue(value: Int) = worldHasTotalValue(this, value)
