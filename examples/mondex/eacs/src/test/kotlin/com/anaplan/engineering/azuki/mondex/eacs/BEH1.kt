...
//    }
    ...
    fun testDSL() {
        given {
            thereIsAnAbstractWorld("AbstractWorld") {
                thereIsAPurse(person1, 10UL)
                thereIsAPurse(person2, 10UL)
                thereIsAPurse(person3, 10UL)
            }
            thereIsAConcreteWorld("ConcreteWorld") {
                thereIsAPurse(person1, 10UL)
                thereIsAPurse(person2, 10UL)
                thereIsAPurse(person3, 10UL)
            }
...
//                hasLost(2)
//            }
//            //LF @EK I like this on `worldExists` because you could later say.
...
//            //
//
//            //LF @EK The UnsupportedChecks should be tied to the expected differences of the Mondex protocol
//            //    between different worlds (i.e. implicitly different DSL chunks for each part)
//            //
//
//            //LF @EK You could also have something like this for the refinement checks
//            //    worldRefines(ABSTRACT, BETWEEN) { ... refinement checks ... }
//            //
//
//            //LF @EK check types per world:
//            //    * All
