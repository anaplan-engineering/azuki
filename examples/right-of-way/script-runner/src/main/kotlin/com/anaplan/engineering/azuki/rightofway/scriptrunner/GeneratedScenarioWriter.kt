...
class GeneratedScenarioWriter(private val scenarioName: String, private val outputDir: File) {
    ...
    fun writeGeneratedScenario(result: OracleScenarioResult) {
        ...
        val oracleBuilder = RightOfWayScriptGeneration.getOracleScenarioBuilder(generatedScenario)
        ...
        val answers = (taskResult as? List<*>)?.filterIsInstance<Answer<*, RightOfWayCheckFactory>>()
