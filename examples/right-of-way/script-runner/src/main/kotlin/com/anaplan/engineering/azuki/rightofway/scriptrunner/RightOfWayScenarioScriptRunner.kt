...
typealias OracleScenarioResult = MultiOracleScenarioRunner.Result<RightOfWayActionFactory, RightOfWayCheckFactory, RightOfWayQueryFactory, RightOfWayActionGeneratorFactory>

typealias OracleScenarioOracleResult = MultiOracleScenarioRunner.OracleResult<RightOfWayActionFactory, RightOfWayCheckFactory, RightOfWayQueryFactory, RightOfWayActionGeneratorFactory>

fun MultiOracleScenarioRunner.OracleResult<RightOfWayActionFactory, RightOfWayCheckFactory, RightOfWayQueryFactory, RightOfWayActionGeneratorFactory>.findTask(
    taskType: TaskType
) = taskResults.find { it.taskType == taskType }

fun MultiOracleScenarioRunner.OracleResult<RightOfWayActionFactory, RightOfWayCheckFactory, RightOfWayQueryFactory, RightOfWayActionGeneratorFactory>.hasTask(
    taskType: TaskType
