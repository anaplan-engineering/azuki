...
class GameScriptGenerationDeclarationBuilder(declaration: GameDeclaration) :
    IgnoreEnvScriptGenerationDeclarationBuilder<TicTacToeGenerationEnvironment, GameDeclaration>(declaration) {
    ...
    override fun getDeclarationScript(): String = if (declaration.moves.isEmpty()) {
